        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#ff9800] px-5 py-2 shadow-lg">
              ...
              <span className="text-sm font-bold text-[#1a237e]">Pakistan's first manual escrow</span>
            </div>
            <div className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2 shadow-lg">
              <ShieldCheck className="h-4 w-4 text-green-600" />
              <span className="text-sm font-bold text-green-700">0% Fraud Risk</span>
            </div>
          </div>
          ...
          <h1 dir="rtl" lang="ur" className="mt-2 font-urdu leading-[2.5]">
            ...
            <span className="mt-4 block text-4xl font-bold text-[#ff9800] sm:text-6xl">نہ پارسل کا فراڈ!</span>
          </h1>
          ...
          <p className="mt-8 max-w-2xl text-pretty text-lg leading-relaxed text-gray-200 sm:text-xl">
            ...
            <span className="font-bold text-white">OloBuy holds your payment securely</span>{' '}
            until you approve it.
          </p>

          {/* SINGLE INTEGRATED CARD */}
          <div className="mt-10 w-full max-w-xl bg-white/5 p-6 rounded-3xl border border-white/10 shadow-xl">
            <a
              href={WHATSAPP_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex h-16 w-full items-center justify-center gap-3 rounded-2xl bg-[#ff9800] px-8 text-xl font-bold text-[#1a237e] shadow-lg transition-all hover:bg-orange-400 active:scale-95 mb-6"
            >
              Start a Safe Deal
