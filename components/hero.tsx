            ...
            <div className="space-y-3 mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <input type="number" placeholder="50000" value={amount} onChange={(e) => setAmount(e.target.value)} className="w-full p-3 rounded-xl border border-gray-300 bg-white text-gray-900 font-medium" />
                </div>
              </div>
            </div>
