  ...
  return (
    <>
      ...
      <section className="relative bg-[#0f172a] py-16 sm:py-24 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,152,0,0.08)_0%,transparent_60%)] pointer-events-none" />
        ...
        <div className="mx-auto max-w-4xl relative z-10">
          ...
          >
            ...
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#ff9800]/10 px-4 py-1.5">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-[#0f172a] leading-[1.15]">
              ...
              <span className="block text-[#ff9800]">without OloBuy</span>
            </h2>
