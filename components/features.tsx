    ...
    <section id="how" className="bg-[#1a237e] py-20 px-4">
      <div className="mx-auto max-w-lg">
        ...
        <div className="flex justify-center mb-16">
          <div className="bg-[#ff9800] text-[#1a237e] font-black py-4 px-10 rounded-full text-xl shadow-[0_0_30px_rgba(255,152,0,0.3)] uppercase tracking-widest text-center">
            How It Works
          </div>
        </div>
