    ...
    >
      ...
      {showEscrowModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
          <div className="bg-[#111827] border border-[#ff9800]/40 rounded-3xl max-w-md w-full p-6 sm:p-8 relative shadow-[0_25px_60px_rgba(0,0,0,0.8)] max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-center mb-6 pr-6">
              ...
              <p className="text-white/60 text-xs sm:text-sm mt-1">
                Exact matching layout matching standard secure transaction flow.
              </p>
            </div>

            {/* Exact Circular Flow Layout Matching Reference Image */}
            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-4 sm:p-6 backdrop-blur-md relative">
              ...
              <div className="flex items-center justify-between relative px-2 mb-8">
                ...
                {/* Goods Flow (Top Arrow pointing Left from Seller to Buyer) */}
                <div className="absolute left-1/2 -translate-x-1/2 top-2 flex flex-col items-center">
                  <div className="inline-flex items-center gap-1.5 text-[#38bdf8] bg-[#38bdf8]/10 px-3 py-1 rounded-full border border-[#38bdf8]/30 text-xs font-bold shadow-[0_0_15px_rgba(56,189,248,0.15)] whitespace-nowrap">
                    <ArrowLeft className="w-3.5 h-3.5 text-[#38bdf8]" />
                    <span className="text-white/90">Goods</span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between px-4 text-xs font-bold mb-8">
                <div className="flex items-center gap-1.5 text-[#eab308] bg-[#eab308]/10 px-3 py-1.5 rounded-full border border-[#eab308]/30">
                  <span>Cash</span>
              ...
              {/* Bottom Node: Escrow Agent */}
              <div className="flex flex-col items-center z-10">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-b from-amber-500/20 to-amber-500/5 border-2 border-amber-500 flex items-center justify-center shadow-xl">
